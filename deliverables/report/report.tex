...
\begin{document}
    ...
    The implementation of run\_simulation() in Junction - the main function in Junction - works as follows. The largest flow rate corresponding
    ...
    seconds the setting is on for being passed in, after which add\_to\_pools() is called on all of the Direction objects to add the number of
