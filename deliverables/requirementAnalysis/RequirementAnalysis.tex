...
Requirement 1.C: the user must be able to input the rate of traffic flow from 
each direction to each other direction via text fields (one per traffic flow) 
in the User Interface (UI).

\subsection{Requirement 2.C}
Requirement 2.C: the user must be able to adjust the following settings for each 
