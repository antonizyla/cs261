...
class Junction:
    ...
    def run_simulation(self):
        ...
        for i in range(0, 4):  # Value to change during development
            if self.accumulator < (3600 / (self.params.get_crossing_rph()[i] if self.params.get_crossing_rph()[i] !=0 else 3600)) or self.params.has_pedestrian_crossing() == [False, False, False, False]:
