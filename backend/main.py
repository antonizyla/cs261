...
j_params = Parameters([3,3,3,3])
northerly_flow = FlowRates(Dir.NORTH, 5, 5, 5, False, 3, False)
easterly_flow = FlowRates(Dir.EAST, 5, 5, 5, False, 3, False)
southerly_flow = FlowRates(Dir.SOUTH, 5, 5, 5, False, 3, False)
westerly_flow = FlowRates(Dir.WEST, 5, 5, 5, False, 3, False)
